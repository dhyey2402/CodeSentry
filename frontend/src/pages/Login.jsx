    ...
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="w-full max-w-[400px] animate-[slide-up_0.6s_ease-out]">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-[15px] text-white/60">Use your CodeSentry Account</p>
        </div>
        ...
        <div className="apple-glass p-8">
          <form className="space-y-4" onSubmit={e => e.preventDefault()}>
            ...
            <div className="pt-4 flex items-center justify-between">
              <Link to="/register" className="text-[14px] text-[#0A84FF] hover:underline font-medium">Create account</Link>
